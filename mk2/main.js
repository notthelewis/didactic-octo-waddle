...
var fs_1 = require("fs");
var lineCounter_1 = require("./lineCounter");
var promises_1 = require("stream/promises");
var args = process.argv.slice(2);
function countAllFiles() {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
        var toReturn, _d, args_1, args_1_1, arg, lineCounter, lineReader, e_1_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    _d = true, args_1 = __asyncValues(args);
                    _e.label = 2;
                case 2: return [4 /*yield*/, args_1.next()];
                case 3:
                    if (!(args_1_1 = _e.sent(), _a = args_1_1.done, !_a)) return [3 /*break*/, 6];
                    _c = args_1_1.value;
                    _d = false;
                    arg = _c;
                    try {
                    ...
                    return [4 /*yield*/, (0, promises_1.pipeline)(lineReader, lineCounter)];
                case 4:
                    _e.sent();
                    toReturn.push({ arg: arg, count: lineCounter.count });
                    _e.label = 5;
                case 5:
                    _d = true;
                    return [3 /*break*/, 2];
                ...
                case 8:
                    ...
                    if (!(!_d && !_a && (_b = args_1.return))) return [3 /*break*/, 10];
                    return [4 /*yield*/, _b.call(args_1)];
                case 9:
                    _e.sent();
                    _e.label = 10;
                ...
                case 13: return [2 /*return*/, toReturn.sort(function (a, b) {
